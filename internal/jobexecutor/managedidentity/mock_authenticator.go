...
func (_m *MockAuthenticator) Authenticate(ctx context.Context, managedIdentities []*gen.ManagedIdentity, credsRetriever func(context.Context, *gen.ManagedIdentity) ([]byte, error)) (*AuthenticateResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []*gen.ManagedIdentity, func(context.Context, *gen.ManagedIdentity) ([]byte, error)) (*AuthenticateResponse, error)); ok {
		return rf(ctx, managedIdentities, credsRetriever)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []*gen.ManagedIdentity, func(context.Context, *gen.ManagedIdentity) ([]byte, error)) *AuthenticateResponse); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, []*gen.ManagedIdentity, func(context.Context, *gen.ManagedIdentity) ([]byte, error)) error); ok {
