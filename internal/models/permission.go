...
var (
	...
	ViewWorkspaceRoleBindingPermission      = registerPermission(types.WorkspaceRoleBindingModelType, ViewAction, true)
	CreateWorkspaceRoleBindingPermission    = registerPermission(types.WorkspaceRoleBindingModelType, CreateAction, true)
	UpdateWorkspaceRoleBindingPermission    = registerPermission(types.WorkspaceRoleBindingModelType, UpdateAction, true)
	DeleteWorkspaceRoleBindingPermission    = registerPermission(types.WorkspaceRoleBindingModelType, DeleteAction, true)
