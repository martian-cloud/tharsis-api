...
// CreateDestroyRunInput is the input for creating a destroy run. The remaining run configuration is
// derived from the workspace's current state in Prepare.
...
func (c *CreateDestroyRun) Prepare(ctx context.Context) error {
...
func (c *CreateDestroyRun) Execute(ctx context.Context, input *types.ExecuteInput) error {
