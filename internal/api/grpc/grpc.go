...
func NewServer(ctx context.Context, options *ServerOptions) *Server {
	...
	var (
		...
		federatedRegistryServer       = servers.NewFederatedRegistryServer(options.ServiceCatalog)
		...
		packageServer                 = servers.NewPackageServer(options.ServiceCatalog)
		...
		terraformCLIVersionsServer    = servers.NewTerraformCLIVersionsServer(options.ServiceCatalog)
	...
	pb.RegisterFederatedRegistriesServer(s, federatedRegistryServer)
	...
	pb.RegisterPackagesServer(s, packageServer)
	...
	pb.RegisterTerraformCLIVersionsServer(s, terraformCLIVersionsServer)
