...
Portions of this file are from: https://github.com/hashicorp/go-tfe.
...
Tharsis modifications:
	...
	- Some of the objects use imported gotfe rather than directly
	referencing the struct.
	- Some of the struct(s) / constant(s) may have various fields
	altered to meet Tharsis' use-case, such as, the Workspace
	struct which does not contain all the relations as found in
	Hashicorp's repo. Likewise, WorkspacePermissions also does
	not contain all fields as seen in the original declaration.
*/
...
// Workspace type is defined here because the go-tfe.Workspace has an issue
// with the jsonapi tags
