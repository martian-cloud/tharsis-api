...
// GetStateVersionByID provides a mock function with given fields: ctx, id
func (_m *MockStateVersions) GetStateVersionByID(ctx context.Context, id string) (*models.StateVersion, error) {
