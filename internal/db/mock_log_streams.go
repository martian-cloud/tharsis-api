...
// ClaimLogStreamsForCompaction provides a mock function with given fields: ctx, limit, claimableBefore
func (_m *MockLogStreams) ClaimLogStreamsForCompaction(ctx context.Context, limit int, claimableBefore time.Time) ([]models.LogStream, error) {
	ret := _m.Called(ctx, limit, claimableBefore)

	if len(ret) == 0 {
		panic("no return value specified for ClaimLogStreamsForCompaction")
	}

	var r0 []models.LogStream
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int, time.Time) ([]models.LogStream, error)); ok {
		return rf(ctx, limit, claimableBefore)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int, time.Time) []models.LogStream); ok {
		r0 = rf(ctx, limit, claimableBefore)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, int, time.Time) error); ok {
		r1 = rf(ctx, limit, claimableBefore)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *MockLogStreams) GetLogStreamByID(ctx context.Context, id string) (*models.LogStream, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetLogStreamByID")
	}
...
func (_m *MockLogStreams) GetLogStreamByJobID(ctx context.Context, jobID string) (*models.LogStream, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetLogStreamByJobID")
	}
...
func (_m *MockLogStreams) GetLogStreamByRunnerSessionID(ctx context.Context, sessionID string) (*models.LogStream, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetLogStreamByRunnerSessionID")
	}
...
func (_m *MockLogStreams) GetLogStreams(ctx context.Context, input *GetLogStreamsInput) (*LogStreamsResult, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetLogStreams")
	}
...
func (_m *MockLogStreams) UpdateLogStream(ctx context.Context, logStream *models.LogStream) (*models.LogStream, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateLogStream")
	}
