...
// GetUserByTRN provides a mock function with given fields: ctx, trnValue
func (_m *MockUsers) GetUserByTRN(ctx context.Context, trnValue string) (*models.User, error) {
