...
func (_m *MockTerraformModuleVersions) GetModuleVersionByID(ctx context.Context, id string) (*models.TerraformModuleVersion, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetModuleVersionByID")
	}
...
// GetModuleVersionByTRN provides a mock function with given fields: ctx, trnValue
func (_m *MockTerraformModuleVersions) GetModuleVersionByTRN(ctx context.Context, trnValue string) (*models.TerraformModuleVersion, error) {
...
func (_m *MockTerraformModuleVersions) UpdateModuleVersion(ctx context.Context, moduleVersion *models.TerraformModuleVersion) (*models.TerraformModuleVersion, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateModuleVersion")
	}
...
func NewMockTerraformModuleVersions(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockTerraformModuleVersions {
