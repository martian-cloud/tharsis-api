...
func (_m *MockActivityEvents) CreateActivityEvent(ctx context.Context, input *models.ActivityEvent) (*models.ActivityEvent, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *models.ActivityEvent) (*models.ActivityEvent, error)); ok {
		return rf(ctx, input)
	}
...
func (_m *MockActivityEvents) GetActivityEvents(ctx context.Context, input *GetActivityEventsInput) (*ActivityEventsResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *GetActivityEventsInput) (*ActivityEventsResult, error)); ok {
		return rf(ctx, input)
	}
