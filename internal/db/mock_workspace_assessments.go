...
// GetWorkspaceAssessmentByTRN provides a mock function with given fields: ctx, trnValue
func (_m *MockWorkspaceAssessments) GetWorkspaceAssessmentByTRN(ctx context.Context, trnValue string) (*models.WorkspaceAssessment, error) {
