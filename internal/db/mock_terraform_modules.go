...
// GetModuleByTRN provides a mock function with given fields: ctx, trnValue
func (_m *MockTerraformModules) GetModuleByTRN(ctx context.Context, trnValue string) (*models.TerraformModule, error) {
...
func (_m *MockTerraformModules) GetModules(ctx context.Context, input *GetModulesInput) (*ModulesResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *GetModulesInput) (*ModulesResult, error)); ok {
		return rf(ctx, input)
	}
...
func NewMockTerraformModules(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockTerraformModules {
