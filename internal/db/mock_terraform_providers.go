...
// GetProviderByTRN provides a mock function with given fields: ctx, trnValue
func (_m *MockTerraformProviders) GetProviderByTRN(ctx context.Context, trnValue string) (*models.TerraformProvider, error) {
