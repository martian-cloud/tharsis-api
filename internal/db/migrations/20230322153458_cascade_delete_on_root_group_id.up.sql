-- In order to add the CASCADE DELETE clause to the foreign key constraints
...
ALTER TABLE IF EXISTS terraform_modules
    ...
    ADD CONSTRAINT fk_root_group_id FOREIGN KEY(root_group_id) REFERENCES groups(id) ON DELETE CASCADE;
