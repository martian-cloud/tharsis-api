...
// GetEventByTRN provides a mock function with given fields: ctx, trnValue
func (_m *MockVCSEvents) GetEventByTRN(ctx context.Context, trnValue string) (*models.VCSEvent, error) {
