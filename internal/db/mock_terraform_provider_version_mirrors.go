...
func (_m *MockTerraformProviderVersionMirrors) CreateVersionMirror(ctx context.Context, versionMirror *models.TerraformProviderVersionMirror) (*models.TerraformProviderVersionMirror, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateVersionMirror")
	}
...
func (_m *MockTerraformProviderVersionMirrors) DeleteVersionMirror(ctx context.Context, versionMirror *models.TerraformProviderVersionMirror) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for DeleteVersionMirror")
	}
...
func (_m *MockTerraformProviderVersionMirrors) GetVersionMirrorByID(ctx context.Context, id string) (*models.TerraformProviderVersionMirror, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetVersionMirrorByID")
	}
...
// GetVersionMirrorByTRN provides a mock function with given fields: ctx, trnValue
func (_m *MockTerraformProviderVersionMirrors) GetVersionMirrorByTRN(ctx context.Context, trnValue string) (*models.TerraformProviderVersionMirror, error) {
	ret := _m.Called(ctx, trnValue)

	if len(ret) == 0 {
		panic("no return value specified for GetVersionMirrorByTRN")
	}
...
func (_m *MockTerraformProviderVersionMirrors) GetVersionMirrors(ctx context.Context, input *GetProviderVersionMirrorsInput) (*ProviderVersionMirrorsResult, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetVersionMirrors")
	}
...
func NewMockTerraformProviderVersionMirrors(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockTerraformProviderVersionMirrors {
