...
func (_m *MockVariables) CreateVariable(ctx context.Context, input *models.Variable) (*models.Variable, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *models.Variable) (*models.Variable, error)); ok {
		return rf(ctx, input)
	}
...
func (_m *MockVariables) CreateVariables(ctx context.Context, namespacePath string, variables []*models.Variable) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateVariables")
	}
...
func (_m *MockVariables) GetVariableByID(ctx context.Context, id string) (*models.Variable, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetVariableByID")
	}
...
func (_m *MockVariables) GetVariables(ctx context.Context, input *GetVariablesInput) (*VariableResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *GetVariablesInput) (*VariableResult, error)); ok {
		return rf(ctx, input)
	}
...
func NewMockVariables(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockVariables {
	mock := &MockVariables{}
