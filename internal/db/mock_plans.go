...
func (_m *MockPlans) GetPlanByID(ctx context.Context, id string) (*models.Plan, error) {
...
// GetPlanByTRN provides a mock function with given fields: ctx, trnValue
func (_m *MockPlans) GetPlanByTRN(ctx context.Context, trnValue string) (*models.Plan, error) {
...
func (_m *MockPlans) GetPlans(ctx context.Context, input *GetPlansInput) (*PlansResult, error) {
	...
	var r0 *PlansResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *GetPlansInput) (*PlansResult, error)); ok {
		return rf(ctx, input)
	}
