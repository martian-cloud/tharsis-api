...
https://github.com/hashicorp/terraform/blob/6b290cf163f6816686bf0a5ae85ff4cb37b3beed/internal/states/statefile/version4.go.
...
Tharsis Modifications:
	...
	- This file may contain struct(s) and function(s) which
	are not seen in the original file or they have been modified.
	Such examples include but are not limited to:
		- stateVersionV4 with int type.
		- stateV4 struct with no CheckResults, RootOutputs removed.
		- ...
*/
...
type stateVersionV4 int

const (
	version4 = stateVersionV4(4)
)
