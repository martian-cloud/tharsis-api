...
import (
	...
	variables "gitlab.com/infor-cloud/martian-cloud/tharsis/tharsis-api/internal/core/run/variables"
)
...
// CreateReconcileRunForWorkspace provides a mock function with given fields: ctx, options
func (_m *MockService) CreateReconcileRunForWorkspace(ctx context.Context, options *CreateReconcileRunForWorkspaceInput) (*models.Run, error) {
	ret := _m.Called(ctx, options)

	if len(ret) == 0 {
		panic("no return value specified for CreateReconcileRunForWorkspace")
	}

	var r0 *models.Run
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *CreateReconcileRunForWorkspaceInput) (*models.Run, error)); ok {
		return rf(ctx, options)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *CreateReconcileRunForWorkspaceInput) *models.Run); ok {
		r0 = rf(ctx, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Run)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *CreateReconcileRunForWorkspaceInput) error); ok {
		r1 = rf(ctx, options)
	} else {
		r1 = ret.Error(1)
	}
...
// DiscardRun provides a mock function with given fields: ctx, options
func (_m *MockService) DiscardRun(ctx context.Context, options *DiscardRunInput) (*models.Run, error) {
	ret := _m.Called(ctx, options)

	if len(ret) == 0 {
		panic("no return value specified for DiscardRun")
	}

	var r0 *models.Run
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *DiscardRunInput) (*models.Run, error)); ok {
		return rf(ctx, options)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *DiscardRunInput) *models.Run); ok {
		r0 = rf(ctx, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Run)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *DiscardRunInput) error); ok {
		r1 = rf(ctx, options)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *MockService) GetRunByNodeID(ctx context.Context, nodeID string) (*models.Run, error) {
...
func (_m *MockService) GetRunVariables(ctx context.Context, runID string, includeSensitiveValues bool) ([]variables.Variable, error) {
	...
	var r0 []variables.Variable
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) ([]variables.Variable, error)); ok {
		return rf(ctx, runID, includeSensitiveValues)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) []variables.Variable); ok {
		r0 = rf(ctx, runID, includeSensitiveValues)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]variables.Variable)
		}
	}
...
// RetryRunNode provides a mock function with given fields: ctx, options
func (_m *MockService) RetryRunNode(ctx context.Context, options *RetryRunNodeInput) (*models.Run, error) {
	ret := _m.Called(ctx, options)

	if len(ret) == 0 {
		panic("no return value specified for RetryRunNode")
	}

	var r0 *models.Run
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *RetryRunNodeInput) (*models.Run, error)); ok {
		return rf(ctx, options)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *RetryRunNodeInput) *models.Run); ok {
		r0 = rf(ctx, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Run)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *RetryRunNodeInput) error); ok {
		r1 = rf(ctx, options)
	} else {
		r1 = ret.Error(1)
	}
...
// SetRunAutoApply provides a mock function with given fields: ctx, runID, autoApply
func (_m *MockService) SetRunAutoApply(ctx context.Context, runID string, autoApply bool) (*models.Run, error) {
	ret := _m.Called(ctx, runID, autoApply)

	if len(ret) == 0 {
		panic("no return value specified for SetRunAutoApply")
	}

	var r0 *models.Run
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) (*models.Run, error)); ok {
		return rf(ctx, runID, autoApply)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) *models.Run); ok {
		r0 = rf(ctx, runID, autoApply)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Run)
		}
...
// UndiscardRun provides a mock function with given fields: ctx, options
func (_m *MockService) UndiscardRun(ctx context.Context, options *UndiscardRunInput) (*models.Run, error) {
	ret := _m.Called(ctx, options)

	if len(ret) == 0 {
		panic("no return value specified for UndiscardRun")
	}

	var r0 *models.Run
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *UndiscardRunInput) (*models.Run, error)); ok {
		return rf(ctx, options)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *UndiscardRunInput) *models.Run); ok {
		r0 = rf(ctx, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Run)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *UndiscardRunInput) error); ok {
		r1 = rf(ctx, options)
	} else {
		r1 = ret.Error(1)
	}
