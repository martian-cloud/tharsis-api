...
const (
	...
	TypeEmailOutboxItem                 Type = "email_outbox_item"
	TypeEmailRecipient                  Type = "email_recipient"
	TypeEmailSuppression                Type = "email_suppression"
	...
	TypePackageVersion                  Type = "package_version"
	TypeResourceLimit                   Type = "resource_limit"
	TypeRole                            Type = "role"
	TypeRun                             Type = "run"
	TypeRunGate                         Type = "run_gate"
	TypeRunGateApproval                 Type = "run_gate_approval"
