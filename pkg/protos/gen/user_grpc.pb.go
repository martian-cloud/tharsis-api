...
const (
	...
	Users_ActivateAdminMode_FullMethodName   = "/martiancloud.tharsis.api.user.Users/ActivateAdminMode"
	Users_DeactivateAdminMode_FullMethodName = "/martiancloud.tharsis.api.user.Users/DeactivateAdminMode"
)
...
type UsersClient interface {
	...
	ActivateAdminMode(ctx context.Context, in *ActivateAdminModeRequest, opts ...grpc.CallOption) (*User, error)
	// DeactivateAdminMode deactivates admin mode for the calling user.
	DeactivateAdminMode(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*User, error)
}
...
func (c *usersClient) ActivateAdminMode(ctx context.Context, in *ActivateAdminModeRequest, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
	err := c.cc.Invoke(ctx, Users_ActivateAdminMode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) DeactivateAdminMode(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
	err := c.cc.Invoke(ctx, Users_DeactivateAdminMode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersServer interface {
	...
	// ActivateAdminMode activates admin mode for the calling user.
	ActivateAdminMode(context.Context, *ActivateAdminModeRequest) (*User, error)
	// DeactivateAdminMode deactivates admin mode for the calling user.
	DeactivateAdminMode(context.Context, *emptypb.Empty) (*User, error)
...
func (UnimplementedUsersServer) ActivateAdminMode(context.Context, *ActivateAdminModeRequest) (*User, error) {
	return nil, status.Error(codes.Unimplemented, "method ActivateAdminMode not implemented")
}
func (UnimplementedUsersServer) DeactivateAdminMode(context.Context, *emptypb.Empty) (*User, error) {
	return nil, status.Error(codes.Unimplemented, "method DeactivateAdminMode not implemented")
}
...
func _Users_ActivateAdminMode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ActivateAdminModeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersServer).ActivateAdminMode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Users_ActivateAdminMode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).ActivateAdminMode(ctx, req.(*ActivateAdminModeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Users_DeactivateAdminMode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersServer).DeactivateAdminMode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Users_DeactivateAdminMode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).DeactivateAdminMode(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Users_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ActivateAdminMode",
			Handler:    _Users_ActivateAdminMode_Handler,
		},
		{
			MethodName: "DeactivateAdminMode",
			Handler:    _Users_DeactivateAdminMode_Handler,
		},
	},
