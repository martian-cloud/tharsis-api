/**
 * @generated SignedSource<<b68f69ccfafa4fb3d80ccea2561e67a4>>
...
export type RunDetailsApplyStageRetryRunNodeMutation$variables = {
  input: RetryRunNodeInput;
};
export type RunDetailsApplyStageRetryRunNodeMutation$data = {
...
export type RunDetailsApplyStageRetryRunNodeMutation = {
  response: RunDetailsApplyStageRetryRunNodeMutation$data;
  variables: RunDetailsApplyStageRetryRunNodeMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "RunDetailsApplyStageRetryRunNodeMutation",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
