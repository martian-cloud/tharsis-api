/**
 * @generated SignedSource<<4c62302f92477d750744d4fed786c354>>
...
export type UndiscardRunInput = {
  clientMutationId?: string | null | undefined;
  runId: string;
};
export type RunDetailsPlanStageUndiscardRunMutation$variables = {
  input: UndiscardRunInput;
};
export type RunDetailsPlanStageUndiscardRunMutation$data = {
  readonly undiscardRun: {
...
export type RunDetailsPlanStageUndiscardRunMutation = {
  response: RunDetailsPlanStageUndiscardRunMutation$data;
  variables: RunDetailsPlanStageUndiscardRunMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "RunDetailsPlanStageUndiscardRunMutation",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
