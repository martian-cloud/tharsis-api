/**
 * @generated SignedSource<<cacd99342969f773cf5772d2acec83ad>>
...
export type DiscardRunInput = {
  clientMutationId?: string | null | undefined;
  runId: string;
};
export type RunDetailsPlanStageDiscardRunMutation$variables = {
  input: DiscardRunInput;
};
export type RunDetailsPlanStageDiscardRunMutation$data = {
  readonly discardRun: {
...
export type RunDetailsPlanStageDiscardRunMutation = {
  response: RunDetailsPlanStageDiscardRunMutation$data;
  variables: RunDetailsPlanStageDiscardRunMutation$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "64c815083eac7ed60bb0c3c0c1079de8",
    "id": null,
    "metadata": {},
    "name": "RunDetailsPlanStageDiscardRunMutation",
...
(node as any).hash = "e59623842bb1e862152876fb67b45347";
