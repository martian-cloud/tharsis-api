...
import WorkspaceOutputVisibilitySettings from './WorkspaceOutputVisibilitySettings';
...
import WorkspaceLabelSettings from './WorkspaceLabelSettings';
...
function WorkspaceSettings(props: Props) {
    ...
    return (
        <Box>
            ...
            <StyledDivider />
            <WorkspaceOutputVisibilitySettings fragmentRef={data} />
            <StyledDivider />
