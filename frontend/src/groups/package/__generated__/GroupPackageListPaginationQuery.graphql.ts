/**
 * @generated SignedSource<<c2ece49ee74ac1a43f6be46ca09514cc>>
...
export type GroupPackageListPaginationQuery$variables = {
...
export type GroupPackageListPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"GroupPackageListFragment_packages">;
  } | null | undefined;
};
export type GroupPackageListPaginationQuery = {
  response: GroupPackageListPaginationQuery$data;
  variables: GroupPackageListPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "GroupPackageListPaginationQuery",
    "selections": [
      {
        "alias": null,
        "args": (v6/*: any*/),
