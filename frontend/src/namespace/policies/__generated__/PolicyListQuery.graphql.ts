...
export type PolicyListQuery$variables = {
  after?: string | null | undefined;
  first: number;
  id: string;
};
export type PolicyListQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"PolicyListFragment_policies">;
  } | null | undefined;
};
export type PolicyListQuery = {
  response: PolicyListQuery$data;
  variables: PolicyListQuery$variables;
};
...
(node as any).hash = "5e94624c39c1be93d3ef080dd123a1aa";
