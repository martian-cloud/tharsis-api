...
export type AnnouncementPaginationQuery$variables = {
  after?: string | null | undefined;
  first?: number | null | undefined;
};
export type AnnouncementPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"AdminAreaAnnouncementListFragment_announcements">;
};
export type AnnouncementPaginationQuery = {
  response: AnnouncementPaginationQuery$data;
  variables: AnnouncementPaginationQuery$variables;
};
