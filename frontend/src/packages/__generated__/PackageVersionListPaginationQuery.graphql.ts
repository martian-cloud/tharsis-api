/**
 * @generated SignedSource<<fecaf3ec7a9fb6451b3dad44e7356cbc>>
...
export type PackageVersionListPaginationQuery$variables = {
...
export type PackageVersionListPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"PackageVersionListFragment_package">;
  } | null | undefined;
};
export type PackageVersionListPaginationQuery = {
  response: PackageVersionListPaginationQuery$data;
  variables: PackageVersionListPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "PackageVersionListPaginationQuery",
    "selections": [
      {
        "alias": null,
        "args": (v5/*: any*/),
